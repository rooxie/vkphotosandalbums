...
use VkPhotosAndAlbums\Models\AlbumsQuery;
...
class AlbumsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'VkPhotosAndAlbums.Models.Map.AlbumsTableMap';
     ...
     */
    const OM_CLASS = '\\VkPhotosAndAlbums\\Models\\Albums';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'VkPhotosAndAlbums.Models.Albums';
     ...
     */
    const COL_OWNER_ID = 'albums.owner_id';
     ...
     */
    const COL_CREATED = 'albums.created';

    /**
     * the column name for the updated field
     */
    const COL_UPDATED = 'albums.updated';

    /**
     * the column name for the size field
     */
    const COL_SIZE = 'albums.size';

    /**
     * the column name for the last_sync field
     */
    const COL_LAST_SYNC = 'albums.last_sync';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\VkPhotosAndAlbums\\Models\\Albums');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \VkPhotosAndAlbums\Models\Albums) { // it's a model object

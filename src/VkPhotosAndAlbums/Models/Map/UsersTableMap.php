...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'VkPhotosAndAlbums.Models.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\VkPhotosAndAlbums\\Models\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'VkPhotosAndAlbums.Models.Users';
     ...
     */
    const COL_LAST_SYNC = 'users.last_sync';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'FirstName', 'LastName', 'LastSync', ),
        self::TYPE_CAMELNAME     => array('id', 'firstName', 'lastName', 'lastSync', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_FIRST_NAME, UsersTableMap::COL_LAST_NAME, UsersTableMap::COL_LAST_SYNC, ),
        self::TYPE_FIELDNAME     => array('id', 'first_name', 'last_name', 'last_sync', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'FirstName' => 1, 'LastName' => 2, 'LastSync' => 3, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'firstName' => 1, 'lastName' => 2, 'lastSync' => 3, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_FIRST_NAME => 1, UsersTableMap::COL_LAST_NAME => 2, UsersTableMap::COL_LAST_SYNC => 3, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'first_name' => 1, 'last_name' => 2, 'last_sync' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\VkPhotosAndAlbums\\Models\\Users');
    ...
    {
        $this->addRelation('Albums', '\\VkPhotosAndAlbums\\Models\\Albums', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':owner_id',
    1 => ':id',
  ),
), null, null, 'Albumss', false);
        $this->addRelation('Photos', '\\VkPhotosAndAlbums\\Models\\Photos', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':owner_id',
    1 => ':id',
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_LAST_SYNC);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \VkPhotosAndAlbums\Models\Users) { // it's a model object

 ...
 * @method     ChildUsersQuery orderByLastSync($order = Criteria::ASC) Order by the last_sync column
 *
 ...
 * @method     ChildUsersQuery groupByLastSync() Group by the last_sync column
 *
 ...
 *
 * @method     ChildUsersQuery leftJoinAlbums($relationAlias = null) Adds a LEFT JOIN clause to the query using the Albums relation
 * @method     ChildUsersQuery rightJoinAlbums($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Albums relation
 * @method     ChildUsersQuery innerJoinAlbums($relationAlias = null) Adds a INNER JOIN clause to the query using the Albums relation
 *
 * @method     ChildUsersQuery joinWithAlbums($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Albums relation
 *
 * @method     ChildUsersQuery leftJoinWithAlbums() Adds a LEFT JOIN clause and with to the query using the Albums relation
 * @method     ChildUsersQuery rightJoinWithAlbums() Adds a RIGHT JOIN clause and with to the query using the Albums relation
 * @method     ChildUsersQuery innerJoinWithAlbums() Adds a INNER JOIN clause and with to the query using the Albums relation
 *
 * @method     ChildUsersQuery leftJoinPhotos($relationAlias = null) Adds a LEFT JOIN clause to the query using the Photos relation
 * @method     ChildUsersQuery rightJoinPhotos($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Photos relation
 * @method     ChildUsersQuery innerJoinPhotos($relationAlias = null) Adds a INNER JOIN clause to the query using the Photos relation
 *
 * @method     ChildUsersQuery joinWithPhotos($joinType = Criteria::INNER_JOIN) Adds a join clause and with to the query using the Photos relation
 *
 * @method     ChildUsersQuery leftJoinWithPhotos() Adds a LEFT JOIN clause and with to the query using the Photos relation
 * @method     ChildUsersQuery rightJoinWithPhotos() Adds a RIGHT JOIN clause and with to the query using the Photos relation
 * @method     ChildUsersQuery innerJoinWithPhotos() Adds a INNER JOIN clause and with to the query using the Photos relation
 *
 * @method     \VkPhotosAndAlbums\Models\AlbumsQuery|\VkPhotosAndAlbums\Models\PhotosQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildUsers findOneByLastSync(string $last_sync) Return the first ChildUsers filtered by the last_sync column *
 ...
 * @method     ChildUsers requireOneByLastSync(string $last_sync) Return the first ChildUsers filtered by the last_sync column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildUsers[]|ObjectCollection findByLastSync(string $last_sync) Return ChildUsers objects filtered by the last_sync column
...
abstract class UsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \VkPhotosAndAlbums\Models\Base\UsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'vk_photos_and_albums', $modelName = '\\VkPhotosAndAlbums\\Models\\Users', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, first_name, last_name, last_sync FROM users WHERE id = :p0';
        try {
    ...
    public function filterByLastSync($lastSync = null, $comparison = null)
    {
        if (is_array($lastSync)) {
            ...
            if (isset($lastSync['min'])) {
                $this->addUsingAlias(UsersTableMap::COL_LAST_SYNC, $lastSync['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($lastSync['max'])) {
                $this->addUsingAlias(UsersTableMap::COL_LAST_SYNC, $lastSync['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UsersTableMap::COL_LAST_SYNC, $lastSync, $comparison);
    }

    /**
     * Filter the query by a related \VkPhotosAndAlbums\Models\Albums object
     *
     * @param \VkPhotosAndAlbums\Models\Albums|ObjectCollection $albums the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
    ...
    public function filterByAlbums($albums, $comparison = null)
    {
        if ($albums instanceof \VkPhotosAndAlbums\Models\Albums) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $albums->getOwnerId(), $comparison);
        } elseif ($albums instanceof ObjectCollection) {
            return $this
                ->useAlbumsQuery()
                ->filterByPrimaryKeys($albums->getPrimaryKeys())
                ->endUse();
        } else {
    ...
    public function filterByPhotos($photos, $comparison = null)
    {
        if ($photos instanceof \VkPhotosAndAlbums\Models\Photos) {
            return $this
                ->addUsingAlias(UsersTableMap::COL_ID, $photos->getOwnerId(), $comparison);

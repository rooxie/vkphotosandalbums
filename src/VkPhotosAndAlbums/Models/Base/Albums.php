...
abstract class Albums implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\VkPhotosAndAlbums\\Models\\Map\\AlbumsTableMap';
    ...
    /**
     * Initializes internal state of VkPhotosAndAlbums\Models\Base\Albums object.
     * @see applyDefaults()
     */
    ...
    public function setOwnerId($v)
    {
        ...
        if ($this->owner_id !== $v) {
            $this->owner_id = $v;
            $this->modifiedColumns[AlbumsTableMap::COL_OWNER_ID] = true;
        }
    ...
    public function setTitle($v)
    {
        ...
        if ($this->title !== $v) {
            $this->title = $v;
            $this->modifiedColumns[AlbumsTableMap::COL_TITLE] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AlbumsTableMap::COL_CREATED] = true;
            }
    ...
    public function setUpdated($v)
    {
        ...
        if ($this->updated !== null || $dt !== null) {
            if ($this->updated === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AlbumsTableMap::COL_UPDATED] = true;
            }
        } // if either are not null
    ...
    public function setSize($v)
    {
        ...
        if ($this->size !== $v) {
            $this->size = $v;
            $this->modifiedColumns[AlbumsTableMap::COL_SIZE] = true;
        }
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            if ($this->last_sync === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_sync->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[AlbumsTableMap::COL_LAST_SYNC] = true;
            }
        } // if either are not null
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(AlbumsTableMap::COL_UPDATED)) {
            $modifiedColumns[':p' . $index++]  = 'updated';
        }
        if ($this->isColumnModified(AlbumsTableMap::COL_SIZE)) {
            $modifiedColumns[':p' . $index++]  = 'size';
        }
        if ($this->isColumnModified(AlbumsTableMap::COL_LAST_SYNC)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\VkPhotosAndAlbums\Models\Albums
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\VkPhotosAndAlbums\Models\Albums The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(AlbumsTableMap::COL_UPDATED)) {
            $criteria->add(AlbumsTableMap::COL_UPDATED, $this->updated);
        }
        if ($this->isColumnModified(AlbumsTableMap::COL_SIZE)) {
            $criteria->add(AlbumsTableMap::COL_SIZE, $this->size);
        }
        if ($this->isColumnModified(AlbumsTableMap::COL_LAST_SYNC)) {
            $criteria->add(AlbumsTableMap::COL_LAST_SYNC, $this->last_sync);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \VkPhotosAndAlbums\Models\Albums (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \VkPhotosAndAlbums\Models\Albums Clone of current object.
     * @throws PropelException
     */
     ...
     * If this ChildAlbums is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildAlbums The current object (for fluent API support)
     */
     ...
     * Otherwise if this Albums is new, it will return
     * an empty collection; or if this Albums has previously
     * been saved, it will retrieve related Photoss from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Albums.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
     ...
     * @return ObjectCollection|ChildPhotos[] List of ChildPhotos objects
     */
    public function getPhotossJoinUsers(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildPhotosQuery::create(null, $criteria);

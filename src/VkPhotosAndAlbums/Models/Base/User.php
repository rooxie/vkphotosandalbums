...
abstract class User implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\VkPhotosAndAlbums\\Models\\Map\\UserTableMap';
    ...
    /**
     * Initializes internal state of VkPhotosAndAlbums\Models\Base\User object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\VkPhotosAndAlbums\Models\User The current object (for fluent API support)
     */
    ...
    public function setLastSync($v)
    {
        ...
        if ($this->last_sync !== null || $dt !== null) {
            if ($this->last_sync === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->last_sync->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[UserTableMap::COL_LAST_SYNC] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UserTableMap::translateFieldName('LastSync', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\VkPhotosAndAlbums\\Models\\User'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_LAST_SYNC)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\VkPhotosAndAlbums\Models\User
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\VkPhotosAndAlbums\Models\User The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserTableMap::COL_LAST_SYNC)) {
            $criteria->add(UserTableMap::COL_LAST_SYNC, $this->last_sync);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \VkPhotosAndAlbums\Models\User (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \VkPhotosAndAlbums\Models\User Clone of current object.
     * @throws PropelException
     */
